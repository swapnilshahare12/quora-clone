...
import "../componentscss/Mobilenavbar.css";
  ...
  return (
    <div className="mobile-navbar">
      ...
      <div className="mobile-center">
        <div className="mobile-logo-box">
          <div className="mobile-logo">
            <svg width="77.287px" height="44px" viewBox="0 0 202 115">
      ...
      <div className="mobile-right">
        <div className="mobile-add-box" data-bs-toggle='modal'
          ...
          <div className="mobile-add-text-box">
            <h1>Add</h1>
          </div>
        </div>
      </div>
